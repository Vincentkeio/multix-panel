...
# ==============================================================================
# MultiX Pro Script V48.0 (Source Code Restoration Edition)
# Author: Vincentkeio & Gemini
# Feature: 3X-UI Sync | Dual Stack | Full UI Interaction | Robust Installer
# ==============================================================================
...
install_master() {
    ...
    echo -e "${YELLOW}🛰️ 正在生成主控端核心程序 (V48.0)...${PLAIN}"
...
<html class="dark">
<head>
    <meta charset="UTF-8"><title>MultiX Pro V48</title>
...
def start_ws():
    ...
    async def m():
        # V48 修复：0.0.0.0 配合 bindv6only=0 实现真·双栈
...
main_menu() {
    clear
    echo -e "${SKYBLUE}🛰️ MultiX Pro 旗舰运维系统 (V48.0 源码复刻版)${PLAIN}"
    echo "------------------------------------------------"
